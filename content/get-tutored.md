...
<div class="page-hero">
  <div class="container">
    ...
    <h1>Get Tutored</h1>
    <p class="lead">
      Tell us your goals — we'll match you with the perfect tutor within 24 hours.
    </p>
  </div>
</div>
  ...
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="box">
          ...
          <form action="https://formspree.io/f/YOUR_FORM_ID" method="POST">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="email">Parent / Contact Email *</label>
            ...
            <div class="form-group">
              <label for="notes">Academic Goals &amp; Details</label>
      ...
      <div class="col-md-4 col-md-offset-1">
        <h4 style="margin-bottom:20px;">What happens next?</h4>
        ...
        <div style="background:#eef2ff;border:1px solid #c7d2fe;border-radius:10px;padding:22px 20px;">
          ...
          <p style="font-size:13.5px;color:#4338ca;margin:0;line-height:1.65;">
            If you're not happy with your first tutor, we'll rematch you for free and credit your session.
          </p>
        </div>
