...
<div class="page-hero">
  <div class="container">
    <div class="badge-pill-accent">We're Hiring</div>
    <h1>Join as a Tutor</h1>
    <p class="lead">
      Make a real impact. Teach on your schedule, earn premium rates, and help students unlock their potential.
    </p>
  </div>
</div>
          ...
          <form action="https://formspree.io/f/YOUR_FORM_ID" method="POST">
            ...
            <div style="margin-top:28px;">
              ...
              <p style="text-align:center;margin-top:12px;font-size:13px;color:#9ca3af;">
                We review all applications carefully and respond within 2–3 business days.
              </p>
            </div>
          </form>
        </div>
